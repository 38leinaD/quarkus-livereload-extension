...
class LiveReloadProcessor {
    ...
    void register(BuildProducer<FilterBuildItem> filter,
        ...
        filter.produce(FilterBuildItem.builder(FEATURE_NAME, LiveReloadScriptInjectionFilter.class.getName()).setLoadOnStartup(1)
                ...
                .build());
        //reflectiveClass.produce(new ReflectiveClassBuildItem(false, false, LiveReloadScriptInjectionFilter.class.getName()));
