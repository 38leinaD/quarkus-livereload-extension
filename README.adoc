...
Or via link:https://jitpack.io/#38leinaD/quarkus-livereload-extension/master-SNAPSHOT[jitpack] by adding the following repository to your `pom.xml`:
...
Now, add the following dependency to a quarkus project `pom.xml`:
